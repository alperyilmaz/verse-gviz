...
RUN install2.r animation blogdown caret citr corrplot DT e1071 feather flexdashboard formatR gapminder ggraph ggrepel leaflet mindr plotly plumber pryr rcrossref selectr swirl tidytext tidygraph tm tweenr wordcloud xgboost \
